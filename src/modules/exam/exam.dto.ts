...
export const ExamGradeRegisterSchemaZod = z.object({
  ...
  answers: z.array(z.object({ questionId: z.string({ required_error: 'El identificador de la pregunta es requerido' }), score: z.number({ required_error: 'El puntaje es requerido' }).min(0).max(10).positive() })),
});
