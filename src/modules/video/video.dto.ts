...
export const CreateVideoSchemaZod = z.object({
  ...
  plan: z.array(
    z.string(),
    { required_error: 'Los planes son requeridos' }
  ),
  semanas: z.array(
    z.number().positive(),
    { required_error: 'Las semanas son requeridas' }
  ),
});
